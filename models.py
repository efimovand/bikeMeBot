...
class Suit(Base):
    ...
    colors: Mapped[list["SuitColor"]] = relationship(back_populates="suit")
    files: Mapped[list["SuitFile"]] = relationship(back_populates="suit")
...
class SuitColor(Base):
    ...
    suit: Mapped["Suit | None"] = relationship(back_populates="colors")


class SuitFile(Base):
    __tablename__ = "suit_file"
    __table_args__ = (
    ...
    suit: Mapped["Suit"] = relationship(back_populates="files")
    color: Mapped["SuitColor"] = relationship()
...
class Boot(Base):
    ...
    colors: Mapped[list["BootColor"]] = relationship(back_populates="boot")
    files: Mapped[list["BootFile"]] = relationship(back_populates="boot")
...
class BootColor(Base):
    ...
    boot: Mapped["Boot | None"] = relationship(back_populates="colors")


class BootFile(Base):
    __tablename__ = "boot_file"
    __table_args__ = (
    ...
    boot: Mapped["Boot"] = relationship(back_populates="files")
    color: Mapped["BootColor"] = relationship()
