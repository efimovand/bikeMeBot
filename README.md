...
**MotoMe** — Telegram-бот, который с помощью генеративного ИИ создаёт фотореалистичные снимки: _ты_ на _своём_ мотоцикле, в _выбранной_ экипировке. Пользователь загружает три своих фото, выбирает байк и снаряжение — бот возвращает готовое изображение в высоком качестве.
